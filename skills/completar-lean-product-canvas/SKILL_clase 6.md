...
description: Guía a equipos de estudiantes para analizar evidencia de experimentos, distinguir hechos de interpretaciones y decidir avanzar, corregir, iterar o pivotar. Usar en la Clase 6 de Desarrollo de Productos, después de ejecutar un experimento y antes de diseñar la solución.
---
...
| Tipo | Dato u observación original | Fuente o registro | Limitación conocida |
|---|---|---|---|
| Cuantitativa | | | |
| Cualitativa | | | |
| Error o anomalía | | | |
...
Pedí una evidencia por vez. Si el equipo trae una conclusión, preguntá:
...
Si la evidencia es parcial, recomendá una propuesta de valor condicional y un MVP que tenga medición incorporada. No frenes al equipo, pero tampoco dejes que presente como validado lo que sigue siendo un supuesto.
